 ...
 */
@Named
public class DcOaiXmlStringConverter implements Converter<XmlStringRecord> {

    public static final String FORMAT_NAME = "oai_dc";
    ...
    public <M extends MetadataFormat> boolean isForFormat(Class<M> formatClass) {
        if(DcOaiFormat.class.equals(formatClass)) {
            return true;
        }
        return false;
    }
