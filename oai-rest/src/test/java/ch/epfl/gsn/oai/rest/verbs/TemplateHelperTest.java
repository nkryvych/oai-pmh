...
public class TemplateHelperTest {
    ...
    public void initSubject() {
        when(templateConfigurationMock.getProperty("datetime.format")).thenReturn(DATE_FORMAT);

        subject = new TemplateHelper(templateConfigurationMock, templateHandlerMock);
    }
